...
Definitions:
Main effect is a change in the value of the dependent variable due to a single indepedent variable.  If there is a difference between means for different levels of the factor, main effect is observed.  Whether this is significant or occurred by chance should be tested. 
```{r}
